#!/bin/bash
# PESPCOIN Masternode Setup Script V2.0.0 for Ubuntu 18.04 LTS
#
...
wget https://github.com/PESPCOIN/PESPCOIN/releases/download/v2.0/PESPCOIN-18.04-ubuntu-daemon.tar.gz
tar -xzvf PESPCOIN-18.04-ubuntu-daemon.tar.gz
